    ...
    <div className="footer">
      ...
      <div className="contacts">
        ...
        <div className="address">
          ...
          <br /> Koramangala, Bengaluru, Karnataka
          <br /> 560034
          <br />
          <br />
          Contact Us: <a href={phoneNum}>080 68216821</a>
          <br />
          Email: <a href={mailURL}>care@uni.club</a>
        </div>
        <div className="grievances">
          <div className="border top"></div>
          <a href={sbmURL}>
            <span>Grievance Redressal Mechanism</span> - SBM Bank India
          </a>
          <div className="border bottom"></div>
        </div>
        <div className="wrapper">
          <div className="social-media">{renderHandles}</div>
          <div className="credit-cards">{renderCreditLinks}</div>
        </div>
      </div>
    </div>
  );
